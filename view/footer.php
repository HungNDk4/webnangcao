    ...
    <div class="container">
        ...
        <div class="border-top py-4">
            <div class="row align-items-center">
                <div class="col-md-6"><span class="small text-muted">© 2025 Bản quyền thuộc về ní. Phát triển bởi Gemini.</span></div>
                <div class="col-md-6">
                    <ul class="list-inline text-md-end mb-0 small text-muted">
                        <li class="list-inline-item"><a href="#!" class="text-reset">Terms of Service</a></li>
